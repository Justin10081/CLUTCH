...
export default function Signup() {
  ...
  const strengthColor = ['', 'var(--color-danger-400)', 'var(--color-warning-400)', 'var(--color-success-400)']
      ...
      <div className="w-full max-w-sm relative z-10 animate-fade-up">
        ...
        <div className="card p-8">
          <div className="mb-6">
            ...
            <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>Free forever. No credit card needed.</p>
          </div>
                  ...
                  <div className="flex gap-1 mb-1">
                    {[1, 2, 3].map(i => (
                      <div key={i} className="h-1 flex-1 rounded-full transition-all duration-300"
                        style={{ backgroundColor: i <= passwordStrength ? strengthColor[passwordStrength] : 'var(--bg-input)' }} />
                    ))}
                  </div>
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--text-muted)' }}>
          ...
          <Link to="/login" className="font-semibold hover:underline" style={{ color: 'var(--color-accent-400)' }}>Sign in</Link>
        </p>
      </div>
    </div>
  )
